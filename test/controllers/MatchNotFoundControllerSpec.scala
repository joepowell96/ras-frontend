...
class MatchNotFoundControllerSpec extends UnitSpec with WithFakeApplication with I18nHelper {

  val fakeRequest = FakeRequest("GET", "/")

  object TestMatchNotFoundController extends MatchNotFoundController

  private def doc(result: Future[Result]): Document = Jsoup.parse(contentAsString(result))

  "MatchNotFoundController" should {
    ...
    "return 200" in {
      val result = TestMatchNotFoundController.get(fakeRequest)
